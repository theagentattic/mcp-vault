...
**Format:**
```markdown
- [weber8thomas/mcp-vault](https://github.com/weber8thomas/mcp-vault) 🐍 ☁️ 🏠 🍎 🪟 🐧 - MCP server for HashiCorp Vault management. Zero secrets sent to AI via tokenization. WebAuthn biometric approval for write operations. Docker/docker-compose config migration.
```
...
3. Add the entry in alphabetical order (mcp-vault goes in the 'm' section)
4. Entry should be:
```markdown
...
```bash
git checkout -b add-mcp-vault
git add README.md
git commit -m "Add mcp-vault MCP server"
git push origin add-mcp-vault
```

Then create PR on GitHub with:
- **Title:** `Add mcp-vault MCP server`
- **Description:**
```markdown
## New MCP Server: mcp-vault
...
**PyPI:** https://pypi.org/project/mcp-vault/
**Documentation:** https://github.com/weber8thomas/mcp-vault#readme
...
- [x] **Published package** - Available on PyPI as `mcp-vault` ✓
...
**Variant 1 (Concise):**
```markdown
- [weber8thomas/mcp-vault](https://github.com/weber8thomas/mcp-vault) 🐍 ☁️ 🏠 🍎 🪟 🐧 - AI-assisted HashiCorp Vault management. Zero secrets sent to AI via tokenization. WebAuthn approval for write operations.
```

**Variant 2 (Focus on security):**
```markdown
- [weber8thomas/mcp-vault](https://github.com/weber8thomas/mcp-vault) 🐍 ☁️ 🏠 🍎 🪟 🐧 - Secure AI-assisted Vault management with secret tokenization (never sent to AI) and WebAuthn biometric approval for write operations.
```

**Variant 3 (Focus on use case):**
```markdown
- [weber8thomas/mcp-vault](https://github.com/weber8thomas/mcp-vault) 🐍 ☁️ 🏠 🍎 🪟 🐧 - Migrate Docker secrets to HashiCorp Vault with AI assistance. Secrets tokenized before reaching AI. WebAuthn approval required for writes.
```
